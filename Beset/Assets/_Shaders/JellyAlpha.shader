        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                if(yDiff >= _jellyBottom){//_epicenterDist > _epicenterSize){
                    ...
                    c.a = 0;
                    /*c = _membraneColor;
                    if(_epicenterDist > _membraneThickness){
                        c.a = (_membraneGradient * (_epicenterDist - _membraneThickness)  );
                    }
                    else{
                        c.a = (_bottomMembraneGradient * (-yDiff) * _epicenterDist);
                    }*/
                }
