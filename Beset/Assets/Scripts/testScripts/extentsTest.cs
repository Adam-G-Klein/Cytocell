...
public class extentsTest : MonoBehaviour {
    ...
    void Start()
    {
        ...
        m_ObjectCollider = gameObject.GetComponent<Collider2D>();
    ...
    void OnMouseDown()
    {
        ...
        Debug.Log(string.Format("extents : {0} center: {1}",m_ObjectCollider.bounds.extents,m_ObjectCollider.bounds.center));
    }
}
