...
//for now this bad boy is always clickable. more importantly he doesn't belong to a button group
public class PauseButton : MonoBehaviour
{
    ...
    [SerializeField]
//    private bool isResumeButton; //script is on both resume button in pause menu
    // and the global pause button itself
    ...
    void Start()
    {
        ...
        print("pause container: " + pauseMenuContainer);
